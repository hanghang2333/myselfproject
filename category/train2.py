...
import TidyAlexnet2 as TidyAlexnet
...
parser.add_argument('--gpu_core',type=str,default='2',help='use which gpu core')
parser.add_argument('--logs',type=str,default='logs/2_0421',help='logs path')
