...
class alexNet(object):
    ...
    def train(self, sess, X_train, Y_train, X_test, Y_test, split,num_epochs, num_count,test_path,logs):
        res = 0.0
        summary_writer = tf.summary.FileWriter(logs+'/orimodel/'+'/train',sess.graph)
        summary_writer1 = tf.summary.FileWriter(logs+'/orimodel/'+'/test',sess.graph)
        ...
        for e in range(num_epochs):
            ...
            if e==150:
                saver.save(sess, logs+'/'+'orimodel/'+str(e)+'orimodel')
